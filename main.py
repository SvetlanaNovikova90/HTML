...
<main>
        ...
        <main class="row">
            ...
            <div class="row text-center">
                ...
                <div class="col-6">
                    <form>
                        <div class="mb-5">
                            <input type="text" name="name"  id="exampleInputEmail1" placeholder="Введите имя">
                        </div>
                        <div class="mb-3">

                            <input type="email"  name="email" id="exampleInputPassword1" aria-describedby="emailHelp" placeholder="Введите email">
                        </div>
  ...
  <a class="btn btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Как купить?</a>
             ...
             <a class="btn btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample3" role="button" aria-expanded="false" aria-controls="multiCollapseExample2">Какая гарантия?</a>
...
<div class="row">
  ...
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample3">
      <div class="card card-body">
       Гарантия указана в карточке продукта
      </div>
    </div>
  </div>
